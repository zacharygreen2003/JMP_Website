      ...
      <div className="w-5/6 flex flex-col items-center justify-center sm:gap-24 sm:py-24 gap-10 py-10">
        ...
        <div>
          ...
          <ServiceDescription
            ...
            desc="J&M is a highly competent manufacturer that can create reliable, cost effective solutions to complement your outsourcing strategy."
            extendedDesc={[
              "J&M is a highly competent manufacturer that can create reliable, cost effective solutions to complement your outsourcing strategy.",
              "J&M Products recognizes the unique challenges customers face when outsourcing Wire Harness, Sub Assemblies and Box Builds.",
            ]}
            float="left"
          />
        </div>
